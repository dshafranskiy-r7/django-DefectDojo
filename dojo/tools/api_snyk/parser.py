...
class ApiSnykParser:
    ...
    def api_scan_configuration_hint(self):
        return (
            "The field <b>Service key 1</b> has to be set with the Snyk project ID. <b>Service key 2</b> "
            "can be used for the Organization ID. If not specified in Service key 2, the Organization ID "
            "should be provided in the extras field as 'OrgID=your-org-id'."
        )
